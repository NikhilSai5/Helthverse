...
//       <View style={styles.container}>
//         <TouchableOpacity
//           style={[styles.box, { backgroundColor: "#C9F0F8" }]}
//           onPress={() => router.push("/report")}
//         >
//           <Text>Medical</Text>
//           <Text style={styles.boxText}>Records</Text>
...
//         </TouchableOpacity>
//         <TouchableOpacity
//           style={[styles.box, { backgroundColor: "#D4F8C9" }]}
//           onPress={() => router.push("/Doctors")}
//         >
//           <Text>Talk to </Text>
//           <Text style={styles.boxText}>Doctors</Text>
...
//         </TouchableOpacity>
//         <TouchableOpacity
//           style={[styles.box, { backgroundColor: "#F8E5C9" }]}
//           onPress={() => router.push("/Prescription")}
//         >
//           <Text>Scan Your</Text>
//           <Text style={styles.boxText}>Prescription</Text>
...
//         </TouchableOpacity>
//         <TouchableOpacity
//           style={[styles.box, { backgroundColor: "#E5C9F8" }]}
//           onPress={() => router.push("/Chatbot")}
//         >
//           <Text>Talk to an</Text>
//           <Text style={styles.boxText}>Assistant</Text>
